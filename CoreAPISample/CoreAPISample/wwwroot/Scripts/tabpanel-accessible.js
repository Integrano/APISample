        ...
        (function (document, window, $, undefined) {
            ...
            var setupTabs = function ($tab, $allTabs, $tabPanels, $tabListItems, i) {
                ...
                $tab.on('click', function (e) {
                    ...
                    tabClick($(this), $allTabs, $tabPanels, $tabListItems, i);
                });
            ...
            var tabClick = function ($thisTab, $allTabs, $tabPanels, $tabListItems, i) {
                $allTabs
                    .attr({
                        'tabindex': -1,
                        'aria-selected': 'false'
                ...
                $tabListItems.eq(i).addClass("active");
            };
